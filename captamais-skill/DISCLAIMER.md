...
2. **Não é recomendação de investimento.** O CaptaMais fornece **ferramentas** de produtividade e
   organização. Dados de mercado, análises de ativos, montagens de carteira e textos gerados por IA
   têm caráter **informativo/de apoio** e **não constituem** recomendação, consultoria ou oferta de
   valores mobiliários. As decisões e a adequação (suitability) são de responsabilidade do
   profissional usuário, observadas as normas aplicáveis (inclusive CVM, quando cabível).

3. **Exatidão e disponibilidade.** Não garantimos a exatidão, completude ou atualidade de dados de
   terceiros (mercado, enriquecimento) nem a disponibilidade contínua da nuvem. **Verifique** antes de
   usar em decisões.
...
6. **Limitação de responsabilidade.** Na máxima extensão permitida em lei, o CaptaMais e seus autores
